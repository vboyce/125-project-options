...
const PRE_TEST_INSTRUCTION = 
    "<p> In this experiment, you will read 4 short stories and answer questions about them. </p>";
    const POST_TEST_INSTRUCTION =
    "<h1>End of the experiment.</h1>"+
    "<h2>Many thanks for participating!</h2>"+
    "<p>This experiment was about how people judge hypocrites and hypocrites who admit to being hypocritical "+
    "compared to people who are not hypocritical.</p>"+
